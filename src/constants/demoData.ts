...
export const INITIAL_DELIVERIES: Delivery[] = [
  {
    ...
    customer: {
      id: 'CUST-ASR-01',
      name: 'Abhinav Kamutala',
      phone: '+91 90191 44983',
      preferredLanguage: 'English / Kannada',
    },
    address: {
      street: 'Flat 101, Asritha Lotus Residency, 14th Main, HSR Layout Sector 4',
      unitOrFlat: 'Flat 101, Block A',
      landmark: 'Near Cambridge Public School',
      city: 'Bengaluru',
      postalCode: '560102',
      latitude: 12.9118,
      longitude: 77.6378,
    ...
    notes: 'Resident at Flat 101. Call on arrival if security needs entry pass.',
  },
  {
    id: 'DEL-ASR-02',
    ...
    address: {
      street: 'Flat 104, Asritha Lotus Residency, 14th Main, HSR Layout Sector 4',
      unitOrFlat: 'Flat 104, Block A',
      landmark: 'Near Cambridge Public School',
      city: 'Bengaluru',
      postalCode: '560102',
      latitude: 12.9118,
    ...
    createdAt: new Date().toISOString(),
    assignedDriverId: 'DRV-BLR-09',
    notes: 'Fragile glass containers — handle with care.',
  },
  {
    id: 'DEL-ASR-03',
    ...
    customer: {
      id: 'CUST-ASR-03',
      name: 'Rohan Nambiar',
      phone: '+91 99011 33445',
      preferredLanguage: 'English / Malayalam',
    },
    address: {
      street: 'Flat 202, Asritha Lotus Residency, 14th Main, HSR Layout Sector 4',
      unitOrFlat: 'Flat 202, Block B',
      landmark: 'Near Cambridge Public School',
      city: 'Bengaluru',
      postalCode: '560102',
      latitude: 12.9118,
    ...
    createdAt: new Date().toISOString(),
    assignedDriverId: 'DRV-BLR-09',
    notes: 'Please do not fold the package garment bag.',
  },
  {
    id: 'DEL-ASR-04',
    ...
    customer: {
      ...
      phone: '+91 97422 44556',
      preferredLanguage: 'English / Marathi',
    },
    address: {
      street: 'Flat 205, Asritha Lotus Residency, 14th Main, HSR Layout Sector 4',
      unitOrFlat: 'Flat 205, Block B',
      landmark: 'Near Cambridge Public School',
      city: 'Bengaluru',
      postalCode: '560102',
      latitude: 12.9118,
    ...
    createdAt: new Date().toISOString(),
    assignedDriverId: 'DRV-BLR-09',
    notes: 'Heavy cast iron cookware — doorstep handoff requested.',
  },
  {
    id: 'DEL-ASR-05',
    ...
    customer: {
      ...
      phone: '+91 98863 55667',
      preferredLanguage: 'English / Tamil',
    },
    address: {
      street: 'Flat 301, Asritha Lotus Residency, 14th Main, HSR Layout Sector 4',
      unitOrFlat: 'Flat 301, Block C',
      landmark: 'Near Cambridge Public School',
      city: 'Bengaluru',
      postalCode: '560102',
      latitude: 12.9118,
    ...
    createdAt: new Date().toISOString(),
    assignedDriverId: 'DRV-BLR-09',
    notes: 'Collector shoe edition — mandatory unboxing video proof.',
  },
  {
    id: 'DEL-ASR-06',
    ...
    customer: {
      id: 'CUST-ASR-06',
      name: 'Sneha Hegde',
      phone: '+91 99164 66778',
      preferredLanguage: 'English / Kannada',
    },
    address: {
      street: 'Flat 304, Asritha Lotus Residency, 14th Main, HSR Layout Sector 4',
      unitOrFlat: 'Flat 304, Block C',
      landmark: 'Near Cambridge Public School',
      city: 'Bengaluru',
      postalCode: '560102',
      latitude: 12.9118,
    ...
    createdAt: new Date().toISOString(),
    assignedDriverId: 'DRV-BLR-09',
    notes: 'Temperature-sensitive ayurvedic formulations.',
  },
  {
    id: 'DEL-ASR-07',
    ...
    customer: {
      ...
      phone: '+91 97315 77889',
      preferredLanguage: 'English / Hindi',
    },
    address: {
      street: 'Flat 402, Asritha Lotus Residency, 14th Main, HSR Layout Sector 4',
      unitOrFlat: 'Flat 402, Block D',
      landmark: 'Near Cambridge Public School',
      city: 'Bengaluru',
      postalCode: '560102',
      latitude: 12.9118,
    ...
    createdAt: new Date().toISOString(),
    assignedDriverId: 'DRV-BLR-09',
    notes: 'Rare books — keep dry and handle with clean hands.',
  },
  {
    id: 'DEL-ASR-08',
    ...
    customer: {
      id: 'CUST-ASR-08',
      name: 'Divya Chandran',
      phone: '+91 98446 88990',
      preferredLanguage: 'English / Telugu',
    },
    address: {
      street: 'Flat 405, Asritha Lotus Residency, 14th Main, HSR Layout Sector 4',
      unitOrFlat: 'Flat 405, Block D',
      landmark: 'Near Cambridge Public School',
      city: 'Bengaluru',
      postalCode: '560102',
      latitude: 12.9118,
    ...
    createdAt: new Date().toISOString(),
    assignedDriverId: 'DRV-BLR-09',
    notes: 'Verify customer ID upon handoff.',
  },
  {
    id: 'DEL-ASR-09',
    ...
    customer: {
      id: 'CUST-ASR-09',
      name: 'Siddharth Rao',
      phone: '+91 99007 99001',
      preferredLanguage: 'English / Kannada',
    },
    address: {
      street: 'Flat 501, Penthouse, Asritha Lotus Residency, 14th Main, HSR Layout Sector 4',
      unitOrFlat: 'Flat 501, Penthouse',
      landmark: 'Near Cambridge Public School',
      city: 'Bengaluru',
      postalCode: '560102',
      latitude: 12.9118,
    ...
    createdAt: new Date().toISOString(),
    assignedDriverId: 'DRV-BLR-09',
    notes: 'Penthouse level — elevator access required.',
  },
  {
    id: 'DEL-ASR-10',
    ...
    customer: {
      id: 'CUST-ASR-10',
      name: 'Meera Krishnan',
      phone: '+91 98808 11223',
      preferredLanguage: 'English / Tamil',
    },
    address: {
      street: 'Flat 503, Penthouse, Asritha Lotus Residency, 14th Main, HSR Layout Sector 4',
      unitOrFlat: 'Flat 503, Penthouse',
      landmark: 'Near Cambridge Public School',
      city: 'Bengaluru',
      postalCode: '560102',
      latitude: 12.9118,
    ...
    createdAt: new Date().toISOString(),
    assignedDriverId: 'DRV-BLR-09',
    notes: 'High security insured delivery. Doorstep OTP and video confirmation mandatory.',
  },
  {
    id: 'DEL-1001',
